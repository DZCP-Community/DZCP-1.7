...
var tinyMCE_GZ = {
    ...
    CallTinyMCE: function() {
        ...
        tinyMCE.init({
            ...
            plugins                             : 'contextmenu,dzcp,inlinepopups,spellchecker,media,autosave',
        ...
        tinyMCE.init({
            ...
            theme                               : 'advanced',
            plugins                             : 'contextmenu,dzcp,inlinepopups,media,autosave',
            language                            : (dzcp_config.lng == 'de' ? dzcp_config.lng : 'en'),
        ...
        tinyMCE.init({
            ...
            theme                               : 'advanced',
            plugins                             : 'contextmenu,dzcp,media,autosave',
            language                            : (dzcp_config.lng == 'de' ? dzcp_config.lng : 'en'),
        ...
        tinyMCE.init({
            ...
            plugins                           : 'contextmenu,dzcp,advimage,paste,table,fullscreen,inlinepopups,spellchecker,searchreplace,insertdatetime,media,autosave',
            language                          : (dzcp_config.lng == 'de' ? dzcp_config.lng : 'en'),
