...
define('_gb_comment_edited', 'Der G&auml;stebuch-Kommentar wurde erfolgreich bearbeitet!');
...
define('_gallery_no_pictures', 'Keine Bilder hinzugef&uuml;gt');
...
define('_server_nousers', '<tr><td class="contentMainFirst" align="center" colspan="99"><span class="fontBold">Keine User auf dem Server</span></td></tr>');
define('_perm_teamspeak', 'Teamspeak 3 Server verwalten');
...
define('_squad', 'Team');
define('_confirm_del_cw', 'Soll dieser Clanwar wirklich gel&ouml;scht werden?');
...
define('_confirm_del_gallery', 'Soll diese Galerie wirklich gel&ouml;scht werden?');
...
define('_confirm_del_server', 'Soll dieser Server wirklich gel&ouml;scht werden?');
define('_confirm_del_artikel', 'Soll dieser Artikel wirklich gel&ouml;scht werden?');
define('_confirm_del_team', 'Soll dieses Team wirklich gel&ouml;scht werden?');
define('_confirm_del_award', 'Soll dieser Award wirklich gel&ouml;scht werden?');
...
define('_gb_titel', '<span class="fontBold">#[postid]</span> von [nick] [email] [hp] am [datum] um [zeit][lang_uhr] [edit] [delete] [comment] [public]');
define('_gb_titel_noreg', '<span class="fontBold">#[postid]</span> von <span class="fontBold">[nick]</span> [email] [hp] am [datum] um [zeit][lang_uhr]  [edit] [delete] [comment] [public]');
...
define('_successful_server_saved', 'Dein Server wurde erfolgreich eingetragen!<br /> Ein Admin wird nun deine Angaben &uuml;berpr&uuml;fen.');
