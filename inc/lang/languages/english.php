...
define('_perm_security', 'manage security center');
...
define('_successful_server_saved' , 'Your server was successfully registered!<br /> An admin will proof this entry soon.');
