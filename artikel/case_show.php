                        ...
                        if (settings::get("reg_artikel") && !$chkMe) {
                            ...
                            if (!ipcheck("artid(" . $_GET['id'] . ")", settings::get('f_artikelcom'))) {
                                ...
                                if ($toCheck) {
                                    ...
                                    array($artikel_id,time(),(isset($_POST['nick']) && !$userid ? stringParser::encode($_POST['nick']) : data('nick')),(isset($_POST['email']) && !$userid ? stringParser::encode($_POST['email']) : data('email')),
                                    (isset($_POST['hp']) && !$userid ? stringParser::encode(links($_POST['hp'])) : stringParser::encode(links(stringParser::decode(data('hp'))))),intval($userid),stringParser::encode($_POST['comment']),$userip));
                    ...
                    if ($sql->rowCount() && !empty($_POST['comment'])) {
                        if ($reg == $userid || permission('artikel')) {
                            ...
                            $sql->update("UPDATE `{prefix_acomments}` SET `nick` = ?, `email` = ?, `hp` = ?, `comment` = ?, `editby` = ?
                                          ...
                                          (isset($_POST['hp']) ? stringParser::encode(links($_POST['hp'])) : ''),
